    ...
    <Main>
      <header>
        <Section>
          <h1>Moin Moin</h1>
          <p>
            Ich bin Tom, Informatikstudent und Screendesigner. Auf meinem
            Portfolio präsentiere ich einige meiner Projekte, die meine
            Entwicklung seit meinem Einstieg in die Softwareentwicklung im Jahr
            2021 widerspiegeln.
          </p>
          <p>
            ...
            Figma beherrschen lernte.
          </p>
          <p>
            Mit meinem Studium in angewandter Informatik vervollständige ich
            derzeit meine technischen Kenntnisse weiter. Während mein bisheriger
            Fokus auf dem Frontend lag, konzentriere ich mich aktuell auf
            Softwareentwicklung.
          </p>
          <p>Ich freue mich auf weitere spannende neue Herausforderungen!</p>
