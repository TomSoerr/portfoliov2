    ...
    <footer className="section-outer">
      <div className="section bg">
        <div className="section-content">
          ...
          <p className="about"> Tom Stöhrer 2025 ©</p>

          <div className="social">
            <h3>Socials</h3>
            <ul>
              <li>
                <a className="link" href="https://www.linkedin.com/in/tom-stöhrer-b5707a265/">LinkedIn</a>
              </li>
              <li>
                <a className="link" href="https://www.xing.com/profile/Tom_Stoehrer/cv">Xing</a>
              </li>
              <li>
